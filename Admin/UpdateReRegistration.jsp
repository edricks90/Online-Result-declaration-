<%-- 
    Document   : UpdateReRegistration
    Created on : Apr 25, 2013, 10:48:09 PM
    Author     : Shiv
--%>
		...
		<form action="../ControllReRegistration"  method="post" name="form1" class="form" id="form1" onsubmit="return kiemtra()" >
						...
						<legend><a href="#">Options</a></legend>
                                                <table>
                                                  ...
                                                  <div class="float-left">
                                                    ...
                                                    <td><ul class="keywords"><li class=" purple-keyword"><%=regid%></li></ul></td>
						...
						<div class="float-left gutter-right">
								 ...
								 <c:forEach items="${regis}" var="r">
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" id="datepicker" name="txtdate" id="stats-period" value="<%=date%>"></span></td>
                                                    </tr>
						</div>
