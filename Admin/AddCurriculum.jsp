<%-- 
    ...
    Created on : Apr 24, 2013, 2:28:23 PM
    Author     : Shiv
--%>
...
<html>
    ...
    <body>
			...
			<li class="write " ><a href="indexAdmin2.jsp?page=Admin&url=Student" title="Student Manage">Student</a>
				...
				<ul>
					<li ><a href="indexAdmin2.jsp?page=Admin&url=Curriculum" title="Curriculum Lists">Curriculum Lists</a></li>
                                        <li class="current"><a href="indexAdmin2.jsp?page=Admin&url=AddCurriculum" title="Add Curriculum Lists">Add Curriculum Lists </a></li>
				</ul>
			</li>
     ...
     <div id="sub-nav"><div class="container_12">
        ...
        %>
				<form action="../ControllCurriculum"  method="post"  name="form1" class="form" id="form1" onsubmit="return kiemtra()" >
					...
					<fieldset class="grey-bg">
						...
						<div class="float-left gutter-right">
                                                    ...
                                                    <td><input type="text" name="txtcurid" id="stats-period" value="" /></td>
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <div class="float-left gutter-right">
                                                    <tr>
                                                    <td><label for="stats-period">Curriculum Name  &nbsp;</label></td>
                                                    <td><span class="input-type-text"><input type="text" name="txtcurname" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <div class="float-left gutter-right">
                                                    <tr>
                                                    <td><label for="stats-period">Time-Period</label></td>
                                                    <td><span class="input-type-text"><input type="text" name="txtperiod" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
