<%-- 
    ...
    Created on : Apr 29, 2013, 4:52:26 PM
    Author     : Shiv
--%>
				...
				<form action="../ControllBranch"  method="post"  name="form1" class="form" id="form1" onsubmit="return kiemtra()" >
					...
					<fieldset class="grey-bg">
						...
						<div class="float-left gutter-right">
                                                    ...
                                                    <td><ul class="keywords"><li class="purple-keyword"><%=b%></li></ul></td>
                                                    <input type="hidden" name="txttemp" value="<%=b%>" />
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtbranchname" id="stats-period" value="<%=br%>"></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtphoneno" id="stats-period" value="<%=p%>"></span></td>
                                                    </tr>
						</div>
