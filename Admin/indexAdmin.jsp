	...
	<script type="text/javascript">
		$(document).ready(function()
		{
			...
			$('#login-form')
			{
				...
				{
					$('#login-block').removeBlockMessages().blockMessage('Please Enter your User Name And Password', {type: 'warning'});
				}
        ...
        <form action="../controllLogin" method="post" name="form1" onsubmit="return kiemtra()"  id="login-form"   class="form with-margin"  >
			...
			<form class="form" id="password-recovery" method="post" action="">
				<fieldset class="grey-bg no-margin collapse">
						<legend><a href="../User/Home.jsp">Go back Home Page</a></legend>
                                                <a href="../User/Home.jsp">User Home Page</a>
