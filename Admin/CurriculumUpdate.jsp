<%-- 
    ...
    Created on : Apr 24, 2013, 1:08:16 PM
    Author     : Shiv
--%>
				...
				<form action="../ControllCurriculum"  method="post"  name="form1" class="form" id="form1" onsubmit="return kiemtra()" >
					...
					<fieldset class="grey-bg">
						...
						<div class="float-left gutter-right">
                                                    ...
                                                    <td><ul class="keywords"><li class="purple-keyword"><%=curid%></li></ul></td>
                                                    <input type="hidden" name="txttemp" value="<%=curid%>" />
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtcurname" id="stats-period" value="<%=curname%>"></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtperiod" id="stats-period" value="<%=period%>"></span></td>
                                                    </tr>
						</div>
