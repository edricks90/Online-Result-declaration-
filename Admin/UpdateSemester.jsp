<%-- 
    ...
    Created on : May 1, 2013, 3:19:32 PM
    Author     : Shiv
--%>
						...
						<legend><a href="#">Options</a></legend>
                                                <table>
                                                  ...
                                                  <div class="float-left">
                                                    ...
                                                    <input type="hidden" name="tempsemname" value="<%=r%>" />
                                                    </tr>
						</div>  
						...
						<div class="float-left gutter-right">
								 ...
								 <c:forEach items="${st1}" var="s1">
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtsemname" id="stats-period" value="<%=g%>"></span></td>
                                                    </tr>
						</div>
