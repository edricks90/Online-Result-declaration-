                        ...
                        %>--%>
                              ...
                              <%--   <% if(drop.equals(subj.subID)){%>
                                ...
                                <option selected="selected" value="${u.username}">${u.username}</option>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="examTime" id="stats-period" value="<%=m%>"></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="mark" id="stats-period" value="<%=ma%>"></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <span class="input-type-text"><input type="text" id="datepicker" name="dateexam" id="stats-period" value="<%=d%>"></span></td>
                                                    </tr>
						</div>
