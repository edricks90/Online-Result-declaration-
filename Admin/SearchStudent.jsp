    ...
    <body>
     ...
     <div id="sub-nav"><div class="container_12">
         ...
         <article class="container_12">
			...
			<div class="block-border"><form class="block-content form" name="formstudent" id="formSuser" method="get" action="SearchStudent">
				<h1>
			...
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				...
				<div class="no-margin">
                    ...
                    <pg:paging pageSize="5" url="indexAdmin2.jsp?page=Admin&url=Student"> 
                       <c:forEach items="${search}" var="s">
						...
						<tr>
							...
							<td><a href="#"><small>${s.gender}</small></a></td>
							<td>${s.phone}</td>
							<td>${s.email}</td>
                                                        
                                                         <c:url var="edit" value="SearchStudent">
                    ...
                    <c:param name="email" value="${s.email}" />
                                                        ...
                                                        <c:url var="delete" value="SearchStudent">
