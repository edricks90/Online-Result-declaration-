				...
				<ul>
					<li ><a href="indexAdmin2.jsp?page=Admin&url=Schedules" title="Schedules Lists">Schedules Lists</a></li>
                        ...
                        <ul>
                         ...
                         <ul>
                                        <li class="current"><a href="indexAdmin2.jsp?page=Admin&url=Semester" title="SemesterLists">Semester Lists</a></li>
		...
		<section class="grid_12">
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				...
				<div class="no-margin">
                    ...
                    <pg:paging pageSize="5" url="indexAdmin2.jsp?page=Admin&url=Semester"> 
                       <c:forEach items="${st}" var="s">
						...
						<tr>
                                                    ...
                                                    <td scope="row" class="table-check-cell "> <ul class="keywords"><li class="orange-keyword"><c:out value="${s.semid}" /></li> </ul> </td>
							
							<td><ul class="keywords">
								<li><a href="#">${s.curid}</a></li>
								
							</ul></td>
							
                                                        <td><ul class="keywords"><li class="purple-keyword">${s.semname}</li></ul></td>
