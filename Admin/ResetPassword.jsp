...
<script language="javascript">
    function kiemtra(){
        var ten = document.form1.txtusername;
        var question = document.form1.txtquestion;
	
	if( laChuoiRong(ten.value) )
	{
     ...
     <div id="sub-nav"><div class="container_12">
        ...
        <section class="grid_8">
			<div class="block-border"><div class="block-content">
				...
				<form action="../ControllResetPass" name="form1" class="form" id="form1" method="post"   onsubmit="return kiemtra()" >
					...
					<fieldset class="grey-bg">
						<legend><a href="#">Options</a></legend>
                                                <table>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtusername" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtquestion" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
			...
			<td><button type="submit" name="btresetpass" value="Submit" ><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Re-Set </button></td>
