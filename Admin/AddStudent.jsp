			...
			<li class="write current" ><a href="indexAdmin2.jsp?page=Admin&url=Student" title="Student Manage">Student</a>
				<ul >
					<li  ><a href="indexAdmin2.jsp?page=Admin&url=Student" title="Student List">Student Lists</a></li>
                                        <li class="current"><a href="indexAdmin2.jsp?page=Admin&url=AddStudent" title="Add Students">Add Students</a></li>
				...
				<form action="../ControllStudent"  method="post"  name="form1" class="form" id="form1" onsubmit="return kiemtra()" >
					...
					<fieldset class="grey-bg">
						...
						<div class="float-left gutter-right">
                                                    ...
                                                    <td><input type="text" name="txtrollno" id="stats-period" value="" /></td>
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtstname" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
