    ...
    <body>
       ...
       <nav id="main-nav">
		...
		<ul class="container_12"  >
			...
			<li class="write current " ><a href="indexAdmin2.jsp?page=Admin&url=Student" title="Student Manage">Student</a>
				<ul >
                                    <li  class="current" ><a href="indexAdmin2.jsp?page=Admin&url=Student" title="Student List">Student Lists</a></li>
     ...
     <div id="sub-nav"><div class="container_12">
         ...
         <%
			...
			<div class="block-border"><form class="block-content form" name="formSuser" id="formSuser" method="get" action="SearchStudent">
				<h1>
		...
		<section class="grid_12">
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				...
				<div class="no-margin">
                    ...
                    <pg:paging pageSize="5" url="indexAdmin.jsp?page=Admin&url=Student"> 
                       <c:forEach items="${st}" var="s">
						...
						<tr>
							...
							<td><ul class="keywords"><li class="red-keyword">${s.phone}</li></ul></td>
                                                        <td><ul class="keywords"><li class="green-keyword">${s.gender}</li></ul></td>
