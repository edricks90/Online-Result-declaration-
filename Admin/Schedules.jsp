    ...
    <body>
		...
		<ul class="container_12"  >
			...
			<li class="backup current "><a href="indexAdmin2.jsp?page=Admin&url=Schedules" title="Schedules Manage">Schedules</a>
				<ul>
                                    <li class="current"><a href="indexAdmin2.jsp?page=Admin&url=Schedules" title="Schedules Lists">Schedules Lists</a></li>
        ...
        %>
			...
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				...
				<div class="no-margin">
                    ...
                    <pg:paging pageSize="5" url="indexAdmin2.jsp?page=Admin&url=Schedules"> 
                       <c:forEach items="${st}" var="s">
						...
						<tr>
                                                    ...
                                                    <td scope="row" class="table-check-cell "> <ul class="keywords"><li class="orange-keyword"><c:out value="${s.scheid}" /></li> </ul> </td>
							
							<td><ul class="keywords">
								<li><a href="#">${s.subid}</a></li>
								
							</ul></td>
                                                        <td><ul class="keywords"><li class="brown-keyword">${s.schename}</li></ul></td>
                                                       
							 <td><ul class="keywords"><li class="purple-keyword">${s.startdate}</li></ul></td>
                                                         
                                                         
                                                         <td><ul class="keywords"><li class="orange-keyword">${s.enddate}</li></ul></td>
                                                        
                                                        <td><ul class="keywords"><li>${s.dateexam}</li></ul></td>
