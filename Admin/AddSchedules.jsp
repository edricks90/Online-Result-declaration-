<%-- 
    Document   : AddSchedul
    Created on : Apr 25, 2013, 9:57:48 PM
    Author     : Shiv
--%>
			...
			<li class="backup current "><a href="indexAdmin2.jsp?page=Admin&url=Schedules" title="Schedules Manage">Schedules</a>
				<ul>
					<li ><a href="indexAdmin2.jsp?page=Admin&url=Schedules" title="Schedules Lists">Schedules Lists</a></li>
                                        <li class="current"><a href="indexAdmin2.jsp?page=Admin&url=AddSchedules" title="Add Schedules">Add Schedules </a></li>
				</ul>
			</li>
						...
						<legend><a href="#">Options</a></legend>
                                                <table>
                                                  ...
                                                  <div class="float-left">
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtscheid" id="stats-period" value=""></span></td>
                                                    <input type="hidden" name="txtup" value="" />
                                                    </tr>
						</div>  
						...
						<div class="float-left gutter-right">
								 ...
								 <c:forEach items="${st1}" var="s">
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtschename" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtfee" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" id="datepicker" name="txtstartdate" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td>  <span class="input-type-text"><input type="text" id="datepicker2" name="txtenddate" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" id="datepicker3" name="txtdateexam" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
