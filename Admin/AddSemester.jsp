<%-- 
    ...
    Created on : May 1, 2013, 4:01:19 PM
    Author     : Shiv
--%>
    ...
    <body>
					...
					<li ><a href="indexAdmin2.jsp?page=Admin&url=Schedules" title="Schedules Lists">Schedules Lists</a></li>
                        ...
                        <ul>
                         ...
                         <ul>
                              ...
                              <li class=" semester current"><a href="indexAdmin2.jsp?page=Admin&url=Semester" title="Semester">Semester</a>
                         <ul>
                                        <li  ><a href="indexAdmin2.jsp?page=Admin&url=Semester" title="SemesterLists">Semester Lists</a></li>
                                        <li class="current"><a href="indexAdmin2.jsp?page=Admin&url=AddSemester" title="AddSemester">Add Semester  </a></li>
                            </ul> 
     ...
     <div id="sub-nav"><div class="container_12">
       ...
       <%
		...
		<form action="../ControllSemester"  method="post" name="form1" class="form" id="form1" onsubmit="return kiemtra()" >
						...
						<legend><a href="#">Options</a></legend>
                                                <table>
                                                  ...
                                                  <div class="float-left">
                                                    ...
                                                    <td><input type="text" name="txtsemid" id="stats-period" value="" /></td></td>
						...
						<div class="float-left gutter-right">
                                                    ...
                                                    <td>
                                                        <select name="ddlcurid" id="stats-sites-0">
								 ...
								 <c:forEach items="${st1}" var="s1">
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <div class="float-left gutter-right">
                                                    <tr>
                                                    <td><label for="stats-period">Semester Name</label></td>
                                                    <td><span class="input-type-text"><input type="text" name="txtsemname" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
