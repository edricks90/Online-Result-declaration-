<%-- 
    ...
    Created on : Apr 23, 2013, 1:06:23 PM
    Author     : Shiv
--%>
...
<html>
    ...
    <body>
     ...
     <div id="sub-nav"><div class="container_12">
        ...
        %>
				<form action="../ControllStudent"  method="post"  name="form1" class="form" id="form1" onsubmit="return kiemtra()" >
					...
					<fieldset class="grey-bg">
						...
						<div class="float-left gutter-right">
                                                    ...
                                                    <input type="hidden" name="txttemp" value="<%=r%>" />
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <div class="float-left gutter-right">
                                                    <tr>
                                                    <td><label for="stats-period">Student Name</label></td>
                                                    <td><span class="input-type-text"><input type="text" name="txtstname" id="stats-period" value="<%=n%>"></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtaddress" id="stats-period" value="<%=a%>"></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtphone" id="stats-period" value="<%=p%>"></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="text" name="txtemail" id="stats-period" value="<%=m%>"></span></td>
                                                    </tr>
						</div>
