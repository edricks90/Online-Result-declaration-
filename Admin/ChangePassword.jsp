...
<script language="javascript">
    function kiemtra(){
        ...
        var passwordold = document.form1.txtpassold;
        var passwordnew = document.form1.txtpassnew;
        var passwordconfig = document.form1.txtpasscofig;
        if( laChuoiRong(username.value))
	{
        ...
        if( laChuoiRong(passwordold.value))
	{
            alert('Password old is not blank!');
            passwordold.focus();
            return false;
	}
        if( laChuoiRong(passwordnew.value))
	{
            alert('Password new is not blank!');
            passwordnew.focus();
            return false;
	}
        if( laChuoiRong(passwordconfig.value))
	{
            alert('Confirm password is not blank!');
            passwordconfig.focus();
            return false;
	}
        ...
        if(passwordnew.value!=passwordconfig.value)
	{
    ...
    <jsp:include page="Include/s_Login.jsp"/>
        ...
        <section class="grid_8">
			<div class="block-border"><div class="block-content">
				...
				<form action="../ControllChangePassoword" name="form1" class="form" id="form1" method="post"   onsubmit="return kiemtra()" >
					...
					<fieldset class="grey-bg">
						...
						<div class="float-left gutter-right">
                                                   ...
                                                   <div class="float-left">
                                                    ...
                                                    <div class="float-left gutter-right">
                                                    <tr>
                                                    <td><label for="stats-period">Password old:</label></td>
                                                    <td><span class="input-type-text"><input type="password" name="txtpassold" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <div class="float-left gutter-right">
                                                    <tr>
                                                    <td><label for="stats-period">Password New &nbsp;&nbsp;</label></td>
                                                    <td><span class="input-type-text"><input type="password" name="txtpassnew" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
                                                    ...
                                                    <td><span class="input-type-text"><input type="password" name="txtpasscofig" id="stats-period" value=""></span></td>
                                                    </tr>
						</div>
			...
			<td><button type="submit" name="btchange" value="Submit" ><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Insert </button></td>
