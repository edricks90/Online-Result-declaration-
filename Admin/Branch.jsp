<%-- 
    Document   : Branch
    Created on : Apr 29, 2013, 8:21:01 PM
    Author     : Shiv
--%>
				...
				<ul>
					<li ><a href="indexAdmin2.jsp?page=Admin&url=Schedules" title="Schedules Lists">Schedules Lists</a></li>
                        ...
                        <ul>
                         ...
                         <ul>
                             <li class="current"><a href="indexAdmin2.jsp?page=Admin&url=Branch" title="BranchLists">Branch Lists</a></li>
		...
		<section class="grid_12">
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="">
				...
				<div class="no-margin">
                    ...
                    <pg:paging pageSize="5" url="indexAdmin.jsp?page=Admin&url=Branch"> 
                       <c:forEach items="${st}" var="s">
						...
						<tr>
                                                    ...
                                                    <td scope="row" class="table-check-cell "> <ul class="keywords"><li class="orange-keyword"><c:out value="${s.branchID}" /></li> </ul> </td>
							
							<td><ul class="keywords">
								<li><a href="#">${s.branchname}</a></li>
								
							</ul></td>
							<td><ul class="keywords"><li class="brown-keyword">${s.address}</li></ul></td>
                                                        <td><ul class="keywords"><li class="purple-keyword">${s.email}</li></ul></td>
							<td><ul class="keywords"><li class="red-keyword">${s.phoneno}</li></ul></td>
                                                        
                                                         <c:url var="edit" value="../ControllBranch">
                                        <c:param name="bt" value="Edit" />
                                        <c:param name="branchID" value="${s.branchID}" />
                                        <c:param name="branchname" value="${s.branchname}" />
                                        <c:param name="address" value="${s.address}" />
                                        <c:param name="email" value="${s.email}" />
                                        <c:param name="phoneno" value="${s.phoneno}" />
                                        
                                        <c:param name="p" value="${param.pageNum}"/> 
                                    </c:url> 
                                                        <c:url var="delete" value="../ControllBranch">
